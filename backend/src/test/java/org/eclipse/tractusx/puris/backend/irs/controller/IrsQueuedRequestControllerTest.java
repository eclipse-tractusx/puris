...
public class IrsQueuedRequestControllerTest {
    ...
    void getAllQueuedRequests_AsAdmin_ReturnsAllFieldsAsDto() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get(REQUESTS_PATH))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$[0].path").value("irs/recursive/chain-openings/grants"))
            .andExpect(MockMvcResultMatchers.jsonPath("$[0].queryParams").value("{\"openingId\":\"" + LINKED_ENTITY_UUID + "\",\"globalAssetId\":\"urn:uuid:some-asset\",\"useCase\":\"PURIS\",\"requesterBpn\":\"BPNL4444444444XX\"}"))
    ...
    private IrsQueuedRequest getFailedGrantUpdateRequest() {
        ...
        .path("irs/recursive/chain-openings/grants")
        .queryParams("{\"openingId\":\"" + LINKED_ENTITY_UUID + "\",\"globalAssetId\":\"urn:uuid:some-asset\",\"useCase\":\"PURIS\",\"requesterBpn\":\"BPNL4444444444XX\"}")
        .body("{\"key\":\"value\"}")
