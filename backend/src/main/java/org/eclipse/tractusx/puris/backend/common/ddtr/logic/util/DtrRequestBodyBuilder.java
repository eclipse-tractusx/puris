...
public class DtrRequestBodyBuilder {
    ...
    public JsonNode createMaterialRegistrationRequestBody(MaterialPartnerRelation materialPartnerRelation) {
        ...
        submodelDescriptorsArray.add(createSubmodelObject(AssetType.ITEM_STOCK_ANONYMIZED_SUBMODEL.URN_SEMANTIC_ID, href, variablesService.getItemStockAnonymizedSubmodelApiAssetId()));
