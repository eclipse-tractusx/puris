...
@WebMvcTest(SingleLevelBomAsPlannedRequestApiController.class)
...
class SingleLevelBomAsPlannedRequestApiControllerTest {
    ...
    @Test
    @WithMockApiKey
    void getSingleLevelBomAsPlanned_GivenNotImplementedPath_Returns501() throws Exception {
