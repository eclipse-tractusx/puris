...
public class PartTypeInformationSAMM {
    ...
    @JsonCreator
	public PartTypeInformationSAMM(@JsonProperty(value = "globalAssetId") String globalAssetId,
    ...
    @Override
    public int hashCode() {
        return Objects.hash(globalAssetId, partTypeInformation, partSitesInformationAsPlanned);
    }
}
