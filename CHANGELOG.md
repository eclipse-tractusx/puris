...
- added documentation for the single-container mock participant used to simulate a partner in local n-tier supply chain tests ([1185](https://github.com/eclipse-tractusx/puris/pull/1185))
