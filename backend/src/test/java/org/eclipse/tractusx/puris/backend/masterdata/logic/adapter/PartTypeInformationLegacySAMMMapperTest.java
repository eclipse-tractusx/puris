...
import org.eclipse.tractusx.puris.backend.masterdata.logic.dto.parttypeinformation.v1.*;
...
@Slf4j
public class PartTypeInformationLegacySAMMMapperTest {
    ...
    void testValidationShouldSuccess() {
        PartTypeInformationLegacySAMM samm = getPartTypeInformationSAMMExample();
    ...
    void testMarshallingAndUnmarshalling() throws Exception {
        PartTypeInformationLegacySAMM partTypeInformationSAMM = getPartTypeInformationSAMMExample();
    ...
    @NotNull
    private static PartTypeInformationLegacySAMM getPartTypeInformationSAMMExample() {
