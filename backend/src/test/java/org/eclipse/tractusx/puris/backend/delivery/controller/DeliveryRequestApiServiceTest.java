...
public class DeliveryRequestApiServiceTest {
    ...
    void setUp() {
        ...
        TEST_CUSTOMER.setUuid(UUID.randomUUID());
    }
    ...
    void noIncotermsUniqueMprRole_testPartnerRolePredicate_returnsTrue() {
        ...
        // partner buys only
        MaterialPartnerRelation mpr = getMpr(false, true);
    ...
    void noIncotermsNonUniqueMprRole_testPartnerRolePredicate_returnsFalse() {
        ...
        // partner buys only
        MaterialPartnerRelation mpr = getMpr(true, true);
        mpr.setPartnerCXNumber(MATERIAL_NUMBER_CX_SUPPLIER);
    ...
    void setIncotermsCustomerRole_testPartnerRolePredicate_filters() {
        ...
        // Responsibilities CUSTOMER and PARTIAL have been found, order IS relevant
    ...
    void setIncotermsSupplierRole_testPartnerRolePredicate_filters() {
        ...
        //then
        assertEquals(2, filteredDeliveries.size());
        // Responsibilities PARTIAL and SUPPLIER have been found, order IS relevant
    ...
    private MaterialPartnerRelation getMpr(boolean partnerSupplies, boolean partnerBuys) {
