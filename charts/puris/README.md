...
An umbrella Helm chart for Kubernetes deployment of PURIS
...
|------------|------|---------|
| file://charts/backend | backend | 1.0.0 |
| file://charts/frontend | frontend | 1.0.0 |
...
| backend.puris.apiversion | string | `"1.0.0"` | Current version of the puris API |
...
| backend.puris.edc.applydataplaneworkaround | bool | `true` |  |
| backend.puris.edc.backend.url | string | `"http://172.17.0.2:32084"` | URL of the EDC backend service |
| backend.puris.edc.controlplane.data.path | string | `"/api/v1/data"` | Data path of the EDC control plane |
| backend.puris.edc.controlplane.data.port | int | `30091` | Data port of the EDC control plane |
| backend.puris.edc.controlplane.host | string | `"172.17.0.2"` | IP address of the EDC control plane |
| backend.puris.edc.controlplane.key | string | `""` | Key for the EDC control plane |
| backend.puris.edc.dataplane.public.port | int | `30784` | Public port of the EDC data plane |
| backend.puris.edc.idsUrl | string | `"http://plato-controlplane:8084/api/v1/ids"` | Own IDS URL of the EDC |
...
| backend.resources.limits | object | `{"cpu":"2000m","memory":"2048Mi"}` | Maximum resource limits of CPU und memory |
| backend.resources.requests | object | `{"cpu":"1000m","memory":"2048Mi"}` | Minimum requested resources for CPU und memory |
| backend.securityContext | object | `{"allowPrivilegeEscalation":false,"runAsGroup":3000,"runAsNonRoot":true,"runAsUser":1000}` | Security configurations |
...
| backend.securityContext.runAsUser | int | `1000` | Configures the user id for a run |
| backend.service.port | int | `8081` | The port of the service |
| backend.service.type | string | `"NodePort"` | Type of the service |
...
| frontend.resources.limits | object | `{"cpu":"500m","memory":"128Mi"}` | Maximum resource limits of CPU und memory |
| frontend.resources.requests | object | `{"cpu":"100m","memory":"128Mi"}` | Minimum requested resources for CPU und memory |
| frontend.securityContext | object | `{"allowPrivilegeEscalation":false,"runAsGroup":3000,"runAsNonRoot":true,"runAsUser":1000}` | Security configurations |
...
| frontend.securityContext.runAsUser | int | `1000` | Configures the user id for a run |
| frontend.service.port | int | `8080` | The port of the service |
| frontend.service.type | string | `"NodePort"` | Type of the service |
...
| global.edc.controlplane | string | `"172.17.0.2"` |  |
