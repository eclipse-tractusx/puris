...
# Wallet stuff
BASE_WALLET_BPN=$ISSUER_BPNL
SEED_WALLETS_BPN=$ISSUER_BPNL,$CUSTOMER_BPNL,$SUPPLIER_BPNL,$TIER2_BPNL
EOF
...
curl -X POST -H "x-api-key: \$KEY" -H "Content-Type: application/json" -d '{ "bpn": "$TIER2_BPNL", "did": "did:web:wallet:$TIER2_BPNL" }' http://localhost:8581/api/management/bpn-directory | jq
echo ""
EOF
...
TIER2_BPNL=$TIER2_BPNL
TIER2_BPNS=$TIER2_BPNS
TIER2_BPNA=$TIER2_BPNA
