        ...
        http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(
                ...
                (authorizeHttpRequests) -> authorizeHttpRequests
                    .requestMatchers("/stockView/**", "/partners/**", "/materials/**", "/materialpartnerrelations/**", "/item-stock/**", "/production/**", "/delivery/**", "/demand/**", "/notification/**", "/planned-production/**", "/material-demand/**", "/delivery-information/**", "/edrendpoint/**", "/edc/**", "/parttypeinformation/**")
                    .authenticated()
