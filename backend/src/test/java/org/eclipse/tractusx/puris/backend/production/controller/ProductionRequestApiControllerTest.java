...
@WebMvcTest(ProductionRequestApiController.class)
@Import({SecurityConfig.class, ApiKeyAuthenticationProvider.class, DtrSecurityConfiguration.class})
class ProductionRequestApiControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockitoBean
    ProductionRequestApiService productionRequestApiService;
    ...
    void getItemStockSamm_GivenNotImplementPath_Returns501() throws Exception {
        ...
        this.mockMvc.perform(
            get("/planned-production/request/material-number/OUTBOUND/description")
