...
export const usePartnerMaterials = (partnerBpnl: BPNL | null) => {
    const endpoint = partnerBpnl ? `${config.app.ENDPOINT_PARTNER}/${partnerBpnl}/materials` : `${config.app.ENDPOINT_MATERIALS}`;
