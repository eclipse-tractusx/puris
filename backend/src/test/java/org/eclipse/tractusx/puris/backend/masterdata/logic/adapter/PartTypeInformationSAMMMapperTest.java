...
public class PartTypeInformationSAMMMapperTest {
    ...
    void testSammMapperShouldSuccess() {
        ...
        Assertions.assertEquals(samm.getGlobalAssetId(), material.getMaterialNumberCx());
    ...
    private static PartTypeInformationSAMM getPartTypeInformationSAMMExample() {
        ...
        partTypeInformationSAMM.setGlobalAssetId(UUID.randomUUID().toString());
        ...
        partSitesInformationAsPlanned.setSiteId("BPNS1234567890ZZ");
        ...
        classification.setDescription("Some Description");
        classification.setId("Some Classification-Id");
        classification.setStandard("Some Classification-Standard");
