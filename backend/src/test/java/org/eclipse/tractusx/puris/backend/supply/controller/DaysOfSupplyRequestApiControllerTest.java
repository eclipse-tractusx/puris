...
@WebMvcTest(DaysOfSupplyRequestApiController.class)
@Import({SecurityConfig.class, ApiKeyAuthenticationProvider.class, DtrSecurityConfiguration.class, VariablesService.class})
class DaysOfSupplyRequestApiControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockitoBean
    DaysOfSupplyRequestApiService daysOfSupplyRequestApiService;

    @Test
    @WithMockApiKey
    void getDaysOfSupplySamm_GivenNotImplementPath_Returns501() throws Exception {

        this.mockMvc.perform(
            get("/days-of-supply/request/material-number/OUTBOUND/description")
