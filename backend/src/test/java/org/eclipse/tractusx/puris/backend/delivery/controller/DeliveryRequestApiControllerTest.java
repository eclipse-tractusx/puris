...
@WebMvcTest(DeliveryRequestApiController.class)
...
class DeliveryRequestApiControllerTest {

    @Autowired
    private MockMvc mockMvc;

    @MockitoBean
    DeliveryRequestApiService deliveryRequestApiService;

    @Test
    @WithMockApiKey
    void getDeliverySamm_GivenNotImplementPath_Returns501() throws Exception {

        this.mockMvc.perform(
            get("/delivery-information/request/material-number/description")
